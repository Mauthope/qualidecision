...
export const qualityService = {
  ...
  evaluateConcessionRisk(
    ...
    if (score >= 75) {
      ...
      recommendation = `Contatar o comprador/garantia de qualidade (${customer.contactName || 'contato comercial'}) antes da expedição para validar amostra ou enviar com desconto acordado.`;
    } else if (score >= 30) {
      riskLevel = 'moderado';
